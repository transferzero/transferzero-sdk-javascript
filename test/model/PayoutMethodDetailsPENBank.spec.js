...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsPENBank();
  });
  ...
  describe('PayoutMethodDetailsPENBank', function() {
    it('should create an instance of PayoutMethodDetailsPENBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsPENBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsPENBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsPENBank);
    });

    it('should have the property firstName (base name: "first_name")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new TransferzeroSdk.PayoutMethodDetailsPENBank();
