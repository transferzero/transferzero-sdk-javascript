...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsGTQBank();
  });
  ...
  describe('PayoutMethodDetailsGTQBank', function() {
    it('should create an instance of PayoutMethodDetailsGTQBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsGTQBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsGTQBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsGTQBank);
    });

    it('should have the property firstName (base name: "first_name")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new TransferzeroSdk.PayoutMethodDetailsGTQBank();
