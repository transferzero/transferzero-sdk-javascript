...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsGBPBank();
  });
  ...
  describe('PayoutMethodDetailsGBPBank', function() {
    it('should create an instance of PayoutMethodDetailsGBPBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsGBPBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsGBPBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsGBPBank);
    });
