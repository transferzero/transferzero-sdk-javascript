...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsXOFBank();
  });
  ...
  describe('PayoutMethodDetailsXOFBank', function() {
    it('should create an instance of PayoutMethodDetailsXOFBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsXOFBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsXOFBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsXOFBank);
    });
