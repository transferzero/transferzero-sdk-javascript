...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsCADBank();
  });
  ...
  describe('PayoutMethodDetailsCADBank', function() {
    it('should create an instance of PayoutMethodDetailsCADBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsCADBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsCADBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsCADBank);
    });
