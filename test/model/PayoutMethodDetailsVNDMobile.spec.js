...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsVNDMobile();
  });
  ...
  describe('PayoutMethodDetailsVNDMobile', function() {
    it('should create an instance of PayoutMethodDetailsVNDMobile', function() {
      // uncomment below and update the code to test PayoutMethodDetailsVNDMobile
      //var instane = new TransferzeroSdk.PayoutMethodDetailsVNDMobile();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsVNDMobile);
    });

    it('should have the property firstName (base name: "first_name")', function() {
      // uncomment below and update the code to test the property firstName
      //var instance = new TransferzeroSdk.PayoutMethodDetailsVNDMobile();
