...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.Currency();
  });
  ...
  describe('Currency', function() {
    it('should create an instance of Currency', function() {
      ...
      //expect(instance).to.be.a(TransferzeroSdk.Currency);
    });
    ...
    it('should have the property subunitToUnit (base name: "subunit_to_unit")', function() {
      // uncomment below and update the code to test the property subunitToUnit
      //var instane = new TransferzeroSdk.Currency();
      //expect(instance).to.be();
    });
