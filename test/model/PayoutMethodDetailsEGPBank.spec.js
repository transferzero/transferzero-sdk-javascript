...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsEGPBank();
  });
  ...
  describe('PayoutMethodDetailsEGPBank', function() {
    it('should create an instance of PayoutMethodDetailsEGPBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsEGPBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsEGPBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsEGPBank);
    });
