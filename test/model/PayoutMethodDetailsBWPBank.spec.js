...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TransferzeroSdk.PayoutMethodDetailsBWPBank();
  });
  ...
  describe('PayoutMethodDetailsBWPBank', function() {
    it('should create an instance of PayoutMethodDetailsBWPBank', function() {
      // uncomment below and update the code to test PayoutMethodDetailsBWPBank
      //var instane = new TransferzeroSdk.PayoutMethodDetailsBWPBank();
      //expect(instance).to.be.a(TransferzeroSdk.PayoutMethodDetailsBWPBank);
    });
